...
const translations = {
  en: {
    ...
    'courses.deleteConfirm': 'Delete this course? This cannot be undone.',
    ...
    'gallery.title': 'Photos and videos',
    'gallery.subtitle': 'Player moments from the course, collected as they happen.',
    'gallery.openCameraUpload': 'Add photo or video',
    'gallery.openCameraForHole': 'Open camera for this hole',
    'gallery.filters': 'Gallery filters',
    'gallery.allRounds': 'All rounds',
    'gallery.all': 'All',
    'gallery.photos': 'Photos',
    'gallery.videos': 'Videos',
    'gallery.loading': 'Loading gallery…',
    'gallery.emptyTitle': 'No media yet',
    'gallery.emptySubtitle': 'The first upload will appear here for every logged-in player.',
    'gallery.itemBy': 'Gallery item by',
    'gallery.video': 'Video',
    'gallery.likes': 'likes',
    'gallery.media': 'Gallery media',
    'gallery.deleteMedia': 'Delete media',
    'gallery.like': 'Like',
    ...
    'gallery.chooseFile': 'Choose file',
    'gallery.hole': 'Hole',
    'gallery.roundMoment': 'Round moment',
    'gallery.caption': 'Caption',
    'gallery.optionalCaption': 'Optional caption',
    ...
    'leaderboard.progressTitle': 'Stableford progress — top 3',
    'leaderboard.progressLoading': 'Loading…',
    'leaderboard.progressError': 'Failed to load data',
    'leaderboard.progressNoData': 'No data yet',
    'leaderboard.progressXAxis': 'Holes',
    'leaderboard.progressYAxis': 'STB',
    'leaderboard.scoreboard': 'Scoreboard',
    'leaderboard.scoreboardPerRound': 'Scoreboard — Stableford points per round',
    'leaderboard.roundLeaderboard': 'Round leaderboard',
    'leaderboard.tournamentLeaderboard': 'Tournament leaderboard',
    'leaderboard.subtitle': 'Official Stableford-based standings and bonus-adjusted rankings.',
    'leaderboard.player': 'Player',
    'leaderboard.total': 'Total',
    'leaderboard.loading': 'Loading scoreboard…',
    'leaderboard.loadError': 'Could not load scoreboard data. Check that the backend is running.',
    'leaderboard.holesLogged': 'holes',
    'leaderboard.selectEvent': 'Select event',
    'leaderboard.noTournaments': 'No tournaments configured yet',
  ...
  nl: {
    ...
    'courses.delete': 'Baan verwijderen',
    'courses.deleteConfirm': 'Deze baan verwijderen? Dit kan niet ongedaan worden gemaakt.',
    ...
    'gallery.title': "Foto's en video's",
    'gallery.subtitle': 'Momenten van spelers op de baan, verzameld terwijl ze gebeuren.',
    'gallery.openCameraUpload': 'Foto of video toevoegen',
    'gallery.openCameraForHole': 'Camera openen voor deze hole',
    'gallery.filters': 'Galerijfilters',
    'gallery.allRounds': 'Alle rondes',
    'gallery.all': 'Alles',
    'gallery.photos': "Foto's",
    'gallery.videos': "Video's",
    'gallery.loading': 'Galerij laden…',
    'gallery.emptyTitle': 'Nog geen media',
    'gallery.emptySubtitle': 'De eerste upload verschijnt hier voor iedere ingelogde speler.',
    'gallery.itemBy': 'Galerij-item van',
    'gallery.video': 'Video',
    'gallery.likes': 'likes',
    'gallery.media': 'Galerijmedia',
    'gallery.deleteMedia': 'Media verwijderen',
    'gallery.like': 'Liken',
    'gallery.unlike': 'Like verwijderen',
    'gallery.delete': 'Verwijderen',
    'gallery.addComment': 'Reactie toevoegen',
    'gallery.post': 'Plaatsen',
    'gallery.addToGallery': 'Toevoegen aan galerij',
    'gallery.cancel': 'Annuleren',
    'gallery.uploading': 'Uploaden…',
    'gallery.publish': 'Publiceren',
    'gallery.uploadFailed': 'Upload mislukt',
    'gallery.camera': 'Camera',
    'gallery.chooseFile': 'Bestand kiezen',
    'gallery.hole': 'Hole',
    'gallery.roundMoment': 'Rondemoment',
    'gallery.caption': 'Bijschrift',
    'gallery.optionalCaption': 'Optioneel bijschrift',
    'gallery.loadError': 'Kan galerij niet laden',

    // Leaderboard
    'leaderboard.currentLeader': 'Huidige leider',
    'leaderboard.currentNumber1': 'Huidig nummer één',
    'leaderboard.progressTitle': 'Progressie Stableford — Top 3',
    'leaderboard.progressLoading': 'Laden…',
    'leaderboard.progressError': 'Kan gegevens niet laden',
    'leaderboard.progressNoData': 'Nog geen gegevens',
    'leaderboard.progressXAxis': 'Holes',
    'leaderboard.progressYAxis': 'STB',
    'leaderboard.scoreboard': 'Scorebord',
    'leaderboard.scoreboardPerRound': 'Scorebord — Stableford punten per ronde',
    'leaderboard.roundLeaderboard': 'Ronde ranglijst',
    'leaderboard.tournamentLeaderboard': 'Toernooi ranglijst',
    'leaderboard.subtitle': 'Officiële Stableford-standen en bonus-gecorrigeerde ranglijst.',
    'leaderboard.player': 'Speler',
    'leaderboard.total': 'Totaal',
    'leaderboard.loading': 'Scorebord laden…',
    'leaderboard.loadError': 'Kon scorebordgegevens niet laden.',
    'leaderboard.holesLogged': 'holes',
    'leaderboard.selectEvent': 'Selecteer evenement',
    'leaderboard.noTournaments': 'Nog geen toernooien geconfigureerd',
